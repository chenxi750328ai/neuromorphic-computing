...
def main() -> int:
    p = argparse.ArgumentParser(description="MNIST ANN Phase2 baseline (陈正共)")
    ...
    out_dir = args.out_dir or (ROOT / "runs" / f"{stamp}_ann")
