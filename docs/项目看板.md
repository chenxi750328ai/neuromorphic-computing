...
> **自动刷新**：小脑写 wake 时由 `scripts/neuro-dashboard-sync.py` 更新（2026-07-28T11:28:35.360776+08:00）
...
**关口**：PR#17 双通+F6 S0（Verilator/RTL-CR）待审 · ≠关口关闭 · Phase8 默认仍不开

## 小脑 focus

- 审 PR#17：F4 双通 + F6 S0 开源仿真门
- Phase8 等总裁书面解除 F2
- 可选 US-EN / TR2 VP

## 待办（唤醒纸条）

- 审 PR#17 双通+F6 S0 · ≠ Phase4.1 了结
- Phase8 等总裁书面解除 F2
- 可选 US-EN / TR2 VP
