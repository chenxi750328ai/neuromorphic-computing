...
> **自动刷新**：小脑写 wake 时由 `scripts/neuro-dashboard-sync.py` 更新（2026-07-27T11:20:06.037438+08:00）
...
**关口**：G-LAT r2 已过(连接复用 p50=3.5ms) · 证据待PR · 非愿景了结 · 禁止单点过关
...
- 继续 Phase4.1：G-LAT 攻关（daemon p50 略超 5ms）· 链路优先 · 禁止单点过关
- 可选：US-EN 混合协议 / TR2 VP_QA 后补
- TR1v2 可留到 Phase4.1 更稳后再批
