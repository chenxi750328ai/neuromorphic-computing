...
> **自动刷新**：小脑写 wake 时由 `scripts/neuro-dashboard-sync.py` 更新（2026-06-22T16:50:01.177036+08:00）

## 当前状态（2026-06-22）

**关口**：Phase4 · FPGA路径B v1 **PR #7 待合**（neuro-ci 绿）· TR2/VP 待签
...
**关口**：Phase4 完成 · FPGA路径B v1 · 待 commit+PR · TR2/VP待签

## 小脑 focus

- FPGA路径B v1：commit + PR（定点SNN+三路对照+HLS参考）
- TR2 Phase4 轻评审签字
- VP 补 VP_QA: PASS（可后补）
...
- TR2 Phase4 轻评审签字
- VP 补 VP_QA: PASS（可后补）
- FPGA路径B commit + PR（feature/* · neuro-ci 绿）
- TR2 Phase4 签字
- VP 补 `VP_QA: PASS`
