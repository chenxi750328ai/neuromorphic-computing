...
| S3c · 硬件冒烟 | FPGA 路径 B · 定点全网络 + 三路对照 | **PASS** 512 样本 acc 97.27% · fixed↔Atlas pred 100% | `fpga_fixedpoint_snn.json` · `fpga_tri_compare.json` |
| S4 · CI | `neuro-ci` 绿 | **PASS** | [PR #3](https://github.com/chenxi750328ai/neuromorphic-computing/pull/3) · [PR #5](https://github.com/chenxi750328ai/neuromorphic-computing/pull/5) · [PR #7](https://github.com/chenxi750328ai/neuromorphic-computing/pull/7) FPGA路径B |
